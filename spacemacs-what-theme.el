;;; spacemacs-what-theme.el --- Color theme with a dark and light versions.
...
(deftheme spacemacs-what "Spacemacs theme, the WHAT version")
...
(defun custom-colors-override ()
  (mapcar (lambda (x) (list (car x) (cdr x)))
          spacemacs-theme-custom-colors))
                                        ...
                                        ;(create-spacemacs-what-theme 'what 'spacemacs-what)

                                        ;(defun create-spacemacs-what-theme (variant 'spacemacs-what)
;; (variant 'what)
(dyn-let ((class '((class color) (min-colors 89)))
          ;; generic                            GUI       TERM
          (act1           (if (true-color-p) "#222226" "#121212") )
          (act2           (if (true-color-p) "#5d4d7a" "#444444") )
          (base           (if (true-color-p) "#f8f8f0" "#b2b2b2") )
          (base-dim       (if (true-color-p) "#686868" "#585858") )
          (bg1            (if (true-color-p) "#1b1d1e" "#262626") )
          ...
          (keyword        (if (true-color-p) "#f92672" "#268bd2") )  ;; Molokai pink
          (lnum           (if (true-color-p) "#403d3d" "#444444") )
          (mat            (if (true-color-p) "#86dc2f" "#86dc2f") )
          (meta           (if (true-color-p) "#9f8766" "#af875f") )
          (str            (if (true-color-p) "#2d9574" "#e6db74") )
...
;;;;; basics
          ...
          `(font-lock-type-face ((class (:foreground ,molokai-blue :inherit bold))))
...
(provide-theme 'spacemacs-what)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; spacemacs-what-theme.el ends here
